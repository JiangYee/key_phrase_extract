...
print('corpus1构建完成！耗时：',str(time_used))
...
print('1关键词tfidf计算完毕！耗时：',str(time_used))
...
print('1摘要tfidf计算完毕！耗时：',str(time_used))
...
print('1关键词rank计算完毕！耗时：',str(time_used))
print('1 over======================================')
...
end_time1 = time.time()
time_used = datetime.timedelta(seconds=int(round(end_time1 - start_time)))
print('corpus2构建完成！耗时：',str(time_used))
...
end_time4 = time.time()
time_used = datetime.timedelta(seconds=int(round(end_time4 - end_time3)))
print('2关键词rank计算完毕！耗时：',str(time_used))
print('2 over======================================')
...
end_time1 = time.time()
time_used = datetime.timedelta(seconds=int(round(end_time1 - start_time)))
print('corpus3构建完成！耗时：',str(time_used))
...
end_time4 = time.time()
time_used = datetime.timedelta(seconds=int(round(end_time4 - end_time3)))
print('3关键词rank计算完毕！耗时：',str(time_used))
print('3 over======================================')
...
end_time1 = time.time()
time_used = datetime.timedelta(seconds=int(round(end_time1 - start_time)))
print('corpus4构建完成！耗时：',str(time_used))
...
end_time1 = time.time()
time_used = datetime.timedelta(seconds=int(round(end_time1 - start_time)))
print('corpus5构建完成！耗时：',str(time_used))
...
end_time4 = time.time()
time_used = datetime.timedelta(seconds=int(round(end_time4 - end_time3)))
print('5关键词rank计算完毕！耗时：',str(time_used))
print('5 over======================================')
